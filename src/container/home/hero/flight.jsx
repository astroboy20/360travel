      ...
      <div>
        <div className="flex gap-2 w-full">
          <div className="relative flex items-center w-3/5">
            ...
            {/* Overlapping span */}
            <span className="absolute z-10 border-2 bg-white text-black rounded-full flex items-center justify-center p-1.5 left-1/2 top-[70%] transform -translate-x-1/2 -translate-y-1/2">
